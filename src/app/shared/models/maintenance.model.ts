...
import { AfterViewInit, DestroyRef, Directive, inject, InjectionToken, OnInit, signal, ViewChild } from '@angular/core';
...
export const COLUMNS_DATA_TABLE = new InjectionToken<string[]>('COLUMNS_DATA_TABLE');
...
export abstract class Repository<G = unknown, C = unknown, U = unknown, D = unknown> {
