...
export class MedidaService {
  ...
  getMedidas(): Observable<Medida[]> {
    return this.http
      ...
      .pipe(map((response) => response as Medida[]));
  }

  create(medida: Medida): Observable<Medida> {
    return this.http
      .post(this.urlEndPoint, medida, { headers: this.httpHeaders })
      .pipe(
  ...
  updateMedida(medida: Medida): Observable<Medida> {
    return this.http
      .put(`${this.urlEndPoint}/${medida.id}`, medida, {
  ...
  deleteMedida(id: number): Observable<Medida> {
    return this.http
      .delete<Medida>(`${this.urlEndPoint}/${id}`, {
        headers: this.httpHeaders,
      })
      .pipe(
        catchError((e) => {
