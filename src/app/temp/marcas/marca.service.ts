...
export class MarcaService {
  ...
  getMarcas(): Observable<Marca[]> {
    return this.http
      ...
      .pipe(map((response) => response as Marca[]));
  }

  create(marca: Marca): Observable<Marca> {
    return this.http
      .post(this.urlEndPoint, marca, { headers: this.httpHeaders })
      .pipe(
  ...
  updateMarca(marca: Marca): Observable<Marca> {
    return this.http
      .put(`${this.urlEndPoint}/${marca.id}`, marca, {
  ...
  deleteMarca(id: number): Observable<Marca> {
    return this.http
      .delete<Marca>(`${this.urlEndPoint}/${id}`, { headers: this.httpHeaders })
      .pipe(
        catchError((e) => {
